...
import gov.goias.mtb.repositories.PerfilRepository;
import gov.goias.mtb.repositories.SistemaRepository;
import gov.goias.mtb.repositories.UsuarioRepository;
...
//        Before(new String[]{"@drop"}, () -> drop());
    ...
    private void starApplicationContext(){
        try{
            ...
            sistemaService = context.getBean(SistemaService.class);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
