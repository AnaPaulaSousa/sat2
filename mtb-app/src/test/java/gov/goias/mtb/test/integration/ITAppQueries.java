package gov.goias.mtb.test.integration;
...
import gov.goias.mtb.conf.mappers.AcessoNegadoExceptionMapper;
import gov.goias.mtb.controllers.AppsQueries;
import gov.goias.mtb.entities.Sistema;
import gov.goias.mtb.services.SistemaService;
import gov.goias.mtb.test.MyCasUserExtractor;
...
public class ITAppQueries extends JerseyTest implements Pt {
    ...
    private static SistemaService sistemas;
    ...
    public static SistemaService mockSistemaService() {
