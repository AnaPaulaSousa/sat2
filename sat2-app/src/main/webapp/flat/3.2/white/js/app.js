...
function initPjax() {
    var a = function () {
		...
		this.pjaxEnabled && (
			...
			$(document).pjax("#sidebar a:not(.accordion-toggle):not([data-no-pjax])", ".content", { fragment: ".content", type: "GET", timeout: 1e4 }), 
    ...
    a.prototype._initOnResizeCallbacks = function () {
        var a, b = this;
        /* removido, pois a mesma estava gerando erro apos a separacao do layout */
